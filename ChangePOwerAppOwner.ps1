...
$AppName = (Get-AdminPowerApp | where {$_.DisplayName -eq 'FirstModelDrivenApp' -and $_.EnvironmentName -eq 'Default-c73a9ec7-32b7-4ada-9758-cf1149af345e'} | Select AppName).AppName
